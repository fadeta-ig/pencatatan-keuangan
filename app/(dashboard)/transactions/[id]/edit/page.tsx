...
export default function EditTransactionPage() {
  ...
  const [transaction, setTransaction] = useState<(FirestoreTransaction & { id: string }) | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Gagal mengupdate transaksi. Silakan coba lagi.');
      setSaving(false);
    }
  };
        ...
        {success && (
          <Alert className="border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              Transaksi berhasil diperbarui! Mengalihkan ke daftar transaksi...
            </AlertDescription>
          </Alert>
        )}
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    disabled={saving || success || filteredCategories.length === 0}
                  >
              ...
              <div className="flex items-center gap-3 pt-4 border-t">
                ...
                <Button
                  type="submit"
                  disabled={saving || success || accounts.length === 0 || filteredCategories.length === 0}
